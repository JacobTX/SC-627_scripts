...
def bot_loc_plot(A,B):
    plt.plot(A,B,'b')
    plt.plot([Ob1.A[0],Ob1.B[0],Ob1.C[0],Ob1.D[0],Ob1.A[0]],[Ob1.A[1],Ob1.B[1],Ob1.C[1],Ob1.D[1],Ob1.A[1]],'r')
    plt.plot([Ob2.A[0],Ob2.B[0],Ob2.C[0],Ob2.D[0],Ob2.A[0]],[Ob2.A[1],Ob2.B[1],Ob2.C[1],Ob2.D[1],Ob2.A[1]],'r')
    plt.plot([Ob3.A[0],Ob3.B[0],Ob3.C[0],Ob3.D[0],Ob3.A[0]],[Ob3.A[1],Ob3.B[1],Ob3.C[1],Ob3.D[1],Ob3.A[1]],'r')
    plt.plot([-5.853,3.873,6.107,-3.619,-5.853],[2.448,2.448,-2.448,-2.448,2.448],'r')
